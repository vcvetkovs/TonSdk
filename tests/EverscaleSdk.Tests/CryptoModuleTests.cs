...
using EverscaleSdk.Modules.Crypto.Models;
using Xunit;
...
namespace EverscaleSdk.Tests
{
    public class CryptoModuleTests
    {
        ...
        private readonly ICryptoModule _sut;

        public CryptoModuleTests()
        {
            _sut = new EverscaleClient().Crypto;
        }
        ...
        [Fact]
        public async Task TonCrc16_IsValid_True()
        {
            // Arrange
            var @params = new ParamsOfTonCrc16()
            {
                Data = HexHelper.ToBase64("0123456789abcdef")
            };

            // Act
            var result = await _sut.TonCrc16(@params);
        ...
        [Fact]
        public async Task ConvertPublicKeyToTonSafeFormat_IsValid_True()
        {
            // Arrange
            var @params = new ParamsOfConvertPublicKeyToTonSafeFormat()
            {
                PublicKey = "06117f59ade83e097e0fb33e5d29e8735bda82b3bf78a015542aaa853bb69600"
            };

            // Act
            var result = await _sut.ConvertPublicKeyToTonSafeFormat(@params);
        ...
        public async Task VerifySignature_IsValid_True()
        {
            ...
            {
                Signed = HexHelper.ToBase64("fb0cfe40eea5d6c960652e6ceb904da8a72ee2fcf6e05089cf835203179ff65bb48c57ecf31dcfcd26510bea67e64f3e6898b7c58300dc14338254268cade10354657374204d657373616765"),
                Public = "1869b7ef29d58026217e9cf163cbfbd0de889bdf1bf4daebf5433a312f5b8d6e"
            };
        ...
        public async Task NaclBoxOpen_IsValid_True()
        {
            ...
            {
                Encrypted = HexHelper.ToBase64("962e17103e24c7fa63436a9d3f4791d9dfcadf4b8df78be83400f1c0"),
                Nonce = "cd7f99924bf422544046e83595dd5803f17536f5c9a11746",
                TheirPublic = "c4e2d9fe6a6baf8d1812b799856ef2a306291be7a7024837ad33a8530db79c6b",
                Secret = "d9b9dc5033fb416134e5d2107fdbacab5aadb297cb82dbdcd137d663bac59f7f"
            };
        ...
        public async Task NaclSecretBoxOpen_IsValid_True()
        {
            ...
            {
                Encrypted = HexHelper.ToBase64("24bede8ca59ed8a5e6aec9ece35c9f5e8405d2dfc2d50f111b2cd0d8"),
                Nonce = "2a33564717595ebe53d91a785b9e068aba625c8453a76e45",
                Key = "8f68445b4e78c000fe4d6b7fc826879c1e63e3118379219a754ae66327764bd8"
            };
        ...
        {
            foreach (var dictionary in new byte?[]{ null, 1, 2, 3, 4, 5, 6, 7, 8 })
            {

...
namespace TonSdk.Tests
{
    public class AbiModuleTests
    {
        ...
        private static class TestData
        {
            ...
            internal static readonly JsonElement MessageBody = JsonDocument.Parse(@"{""id"":""0x0""}").RootElement;
        ...
        [Fact]
        public async Task AttachSignature_EventsAbiContractMessage_IsValid()
        {
            // Arrange

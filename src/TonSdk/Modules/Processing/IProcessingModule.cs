...
namespace TonSdk.Modules.Processing
{
    ...
    public interface IProcessingModule
    {
        ...
        /// &ltadd correct config params here>
        ...
        /// </summary>
        Task<ResultOfProcessMessage> ProcessMessage<T, TSigner>(ParamsOfProcessMessage<TSigner> @params, Action<T, FunctionExecutionStatus> callback = null);
    }
}

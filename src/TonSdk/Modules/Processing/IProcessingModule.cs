...
namespace TonSdk.Modules.Processing
{
    ...
    public interface IProcessingModule
    {
        ...
        ///     logging of new shard blocks creation during message processing.  <para/>
        ///     
        ...
        ///     for contracts which ABI includes \"expire\" header.  <para/>
        ///     
        ...
        ///     Decodes the output messages's bodies.  <para/>
        ///     
        ///     If contract's ABI includes "expire" header then
        ///     SDK implements retries in case of unsuccessful message delivery within the expiration
        ///     timeout: SDK recreates the message, sends it and processes it again.  <para/>
        ///     
        ...
        ///     and logged into the supplied callback function.  <para/>
        ///     
        ///     The retry configuration parameters are defined in the client's
        ///     <see cref="Configs.NetworkConfig"/> and <see cref="Configs.AbiConfig"/>.  <para/>
        ///     
